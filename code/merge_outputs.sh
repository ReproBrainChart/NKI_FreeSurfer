#!/bin/bash
set -e -u -x
outputsource=ria+file:///cbica/projects/RBC/freesurfer_stats/NKI/fs-tabulate/output_ria#2e2d6f86-431e-4cf9-bdea-1910c945eea5
cd /cbica/projects/RBC/freesurfer_stats/NKI/fs-tabulate
